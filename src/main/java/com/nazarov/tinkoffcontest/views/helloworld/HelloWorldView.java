package com.nazarov.tinkoffcontest.views.helloworld;

import com.nazarov.application.data.entity.SampleAddress;
import com.nazarov.application.data.service.SampleAddressService;
import com.nazarov.tinkoffcontest.views.MainLayout;
...
public class HelloWorldView extends Div {
    ...
    public HelloWorldView(SampleAddressService addressService) {
